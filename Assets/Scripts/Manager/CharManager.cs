...
public class CharManager : MonoBehaviourPunCallbacks
{
    ...
    public void GetPlayerInfo(CharBase needTarget, CharBase provider)
    {
        ...
        needTarget.HeadSuit = provider.HeadSuit;
        needTarget.ArmorSuit = provider.ArmorSuit;
        needTarget.HeadSuit = provider.HeadSuit;
        needTarget.KneeSuit = provider.KneeSuit;
        needTarget.TrousersSuit = provider.TrousersSuit;
        needTarget.BootsSuit = provider.BootsSuit;
