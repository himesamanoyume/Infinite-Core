 ...
 * @LastEditTime: 2022-02-16 10:08:07
...
3v3/5v5玩家对战，每个玩家的可以选择不同定位的角色，不同定位的角色有不同的数个技能，玩家可以根据需求提升技能等级。
...
所有玩家初始复活时间为10s，每死亡1次增加10s，最大为120s
...
装备分为4个品质等级：普通[蓝]、神器[紫]、史诗[黄]、奇特[红]
...
- 持之以恒[普攻倍率增加]
- 天赋异禀[技能倍率增加]
- 虚晃一枪[技能释放后有一定概率无冷却时间]
- 心急如焚[技能冷却时间减少]
- 嗜血狂魔[根据造成的伤害按百分比获取生命]
- 狂战士[生命越少，攻速越快，暴击爆伤增加]
- 固若金汤[根据防御生成护盾，攻击下降，护盾被破坏后60秒后才能生成，造成伤害时回复损失的护盾值，护盾被破坏时对周围造成一次伤害]

> 代码：施放方，受击方要能够快速获取

- 涌泉相报[根据受到伤害返还给敌人]
- 赏金猎人[该角色所持金币越多，攻击力增加，移速增加]
- 生命源泉[生命恢复增加]
- 狂暴轰入[攻速增加]
